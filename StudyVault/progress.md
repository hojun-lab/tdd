...
| D5 | PlatformTransactionManager & Connection Binding | DEEP | COMPLETE | 2026-04-22 | ThreadLocal로 커넥션 바인딩, ConnectionHolder 직접 구현, identityHashCode로 같은 커넥션 공유 증명 |
...
| v3 | + ThreadLocal ConnectionHolder | COMPLETE | ConnectionHolder(ThreadLocal 기반) 구현, DataSource로 전환, identityHashCode로 커넥션 공유 검증 |
